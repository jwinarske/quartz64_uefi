...
#define PCIE2X1_SEGMENT     ((PCIE2X1_S_BASE - 0x300000000UL) / 0x40000000UL)
#define PCIE3X1_SEGMENT     ((PCIE3X1_S_BASE - 0x300000000UL) / 0x40000000UL)
#define PCIE3X2_SEGMENT     ((PCIE3X2_S_BASE - 0x300000000UL) / 0x40000000UL)
